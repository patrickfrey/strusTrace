 ...
 */
/// \brief Interface for mapping call trace identifiers to their internal representation as number and back
/// \file traceIdMapInterface.hpp
#ifndef _STRUS_TRACE_IDMAP_INTERFACE_HPP_INCLUDED
#define _STRUS_TRACE_IDMAP_INTERFACE_HPP_INCLUDED
...
public:
	...
	virtual std::vector<TraceElement> unpackElements(
			...
			std::size_t packedStructSize) const=0;
};
