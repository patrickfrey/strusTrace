...
{
	static const char* ar[] = { "Destructor", "mapVectorToConcepts", "featureConcepts", "featureVector", "featureName", "featureIndex", "conceptFeatures", "nofConcepts", "nofFeatures", "config"};
	return ar[mid];
}
