...
public:
	enum MethodId
	{
		...
		Method_termTypeNumber=12,
		Method_isForwardIndexTerm=13,
		Method_createTermTypeIterator=14,
		Method_createTermValueIterator=15,
		Method_createDocIdIterator=16,
		Method_createUserNameIterator=17,
		Method_documentStatistics=18,
		Method_createMetaDataReader=19,
		Method_createMetaDataRestriction=20,
		Method_createAttributeReader=21,
		Method_createTransaction=22,
		Method_createAllStatisticsIterator=23,
		Method_createChangeStatisticsIterator=24,
		Method_getStatisticsProcessor=25,
		Method_createDocumentChecker=26,
		Method_checkStorage=27,
		Method_close=28
	};
	static const char* methodName( MethodId mid);
};
