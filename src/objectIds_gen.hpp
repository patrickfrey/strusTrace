...
public:
	enum MethodId
	{
		...
		Method_termTypeNumber=17,
		Method_termValueNumber=18,
		Method_isForwardIndexTerm=19,
		Method_createTermTypeIterator=20,
		Method_createStructTypeIterator=21,
		Method_createTermValueIterator=22,
		Method_createDocIdIterator=23,
		Method_createUserNameIterator=24,
		Method_documentStatistics=25,
		Method_createMetaDataReader=26,
		Method_createMetaDataRestriction=27,
		Method_createAttributeReader=28,
		Method_createTransaction=29,
		Method_createAllStatisticsIterator=30,
		Method_createChangeStatisticsIterator=31,
		Method_getChangeStatisticTimeStamps=32,
		Method_loadChangeStatisticsMessage=33,
