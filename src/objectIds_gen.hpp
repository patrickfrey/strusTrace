...
public:
	enum MethodId
	{
		...
		Method_diskUsage=2,
		Method_config=3,
		Method_createTermPostingIterator=4,
		Method_createFrequencyPostingIterator=5,
		Method_createStructIterator=6,
		Method_createBrowsePostingIterator=7,
		Method_createForwardIterator=8,
		Method_createDocumentTermIterator=9,
		Method_createInvAclIterator=10,
		Method_createAclReader=11,
		Method_nofDocumentsInserted=12,
		Method_documentFrequency=13,
		Method_maxDocumentNumber=14,
		Method_documentNumber=15,
		Method_termTypeNumber=16,
		Method_termValueNumber=17,
		Method_isForwardIndexTerm=18,
		Method_createTermTypeIterator=19,
		Method_createStructTypeIterator=20,
		Method_createTermValueIterator=21,
		Method_createDocIdIterator=22,
		Method_createUserNameIterator=23,
		Method_documentStatistics=24,
		Method_createMetaDataReader=25,
		Method_createMetaDataRestriction=26,
		Method_createAttributeReader=27,
		Method_createTransaction=28,
		Method_createAllStatisticsIterator=29,
		Method_createChangeStatisticsIterator=30,
		Method_getChangeStatisticTimeStamps=31,
		Method_loadChangeStatisticsMessage=32,
		Method_getStatisticsProcessor=33,
		Method_createDocumentChecker=34,
		Method_createDump=35,
		Method_getConfigParameters=36,
		Method_checkStorage=37,
		Method_close=38,
		Method_compaction=39
	};
	static const char* methodName( MethodId mid);
};
