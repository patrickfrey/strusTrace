...
public:
	enum MethodId
	{
		...
		Method_createTermTypeIterator=13,
		Method_createTermValueIterator=14,
		Method_createDocIdIterator=15,
		Method_createUserNameIterator=16,
		Method_documentStatistics=17,
		Method_createMetaDataReader=18,
		Method_createMetaDataRestriction=19,
		Method_createAttributeReader=20,
		Method_createTransaction=21,
		Method_createAllStatisticsIterator=22,
		Method_createChangeStatisticsIterator=23,
		Method_getStatisticsProcessor=24,
		Method_createDocumentChecker=25,
		Method_checkStorage=26,
		Method_close=27
	};
	static const char* methodName( MethodId mid);
};
