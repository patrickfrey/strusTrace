...
public:
	enum MethodId
	{
		...
		Method_reload=1,
		Method_config=2,
		Method_createTermPostingIterator=3,
		Method_createStructIterator=4,
		Method_createBrowsePostingIterator=5,
		Method_createFieldPostingIterator=6,
		...
		Method_isForwardIndexTerm=16,
		Method_createTermTypeIterator=17,
		Method_createStructTypeIterator=18,
		Method_createTermValueIterator=19,
		Method_createDocIdIterator=20,
		Method_createUserNameIterator=21,
		Method_documentStatistics=22,
		Method_createMetaDataReader=23,
