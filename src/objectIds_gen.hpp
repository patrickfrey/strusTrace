...
public:
	enum MethodId
	{
		...
		Method_createStructIterator=5,
		Method_createBrowsePostingIterator=6,
		Method_createForwardIterator=7,
		Method_createDocumentTermIterator=8,
		Method_createInvAclIterator=9,
		Method_createAclReader=10,
		Method_nofDocumentsInserted=11,
		Method_documentFrequency=12,
		Method_maxDocumentNumber=13,
		Method_documentNumber=14,
		Method_termTypeNumber=15,
		Method_termValueNumber=16,
		Method_isForwardIndexTerm=17,
		Method_createTermTypeIterator=18,
		Method_createStructTypeIterator=19,
		Method_createTermValueIterator=20,
		Method_createDocIdIterator=21,
		Method_createUserNameIterator=22,
		Method_documentStatistics=23,
		Method_createMetaDataReader=24,
		Method_createMetaDataRestriction=25,
		Method_createAttributeReader=26,
		Method_createTransaction=27,
