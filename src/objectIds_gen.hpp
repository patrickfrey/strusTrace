...
enum ClassId
{
	...
	ClassId_DocumentClassDetector=16,
	ClassId_DocumentTermIterator=17,
	ClassId_ForwardIterator=18,
	ClassId_InvAclIterator=19,
	ClassId_MetaDataReader=20,
	ClassId_MetaDataRestrictionInstance=21,
	ClassId_MetaDataRestriction=22,
	ClassId_NormalizerFunctionInstance=23,
	ClassId_NormalizerFunction=24,
	ClassId_PatternLexerContext=25,
	ClassId_PatternLexerInstance=26,
	ClassId_PatternLexer=27,
	ClassId_PatternMatcherContext=28,
	ClassId_PatternMatcherInstance=29,
	ClassId_PatternMatcher=30,
	ClassId_PatternTermFeederInstance=31,
	ClassId_PatternTermFeeder=32,
	ClassId_PostingIterator=33,
	ClassId_PostingJoinOperator=34,
	ClassId_QueryAnalyzerContext=35,
	ClassId_QueryAnalyzer=36,
	ClassId_QueryEval=37,
	ClassId_Query=38,
	ClassId_QueryProcessor=39,
	ClassId_ScalarFunctionInstance=40,
	ClassId_ScalarFunction=41,
	ClassId_ScalarFunctionParser=42,
	ClassId_SegmenterContext=43,
	ClassId_SegmenterInstance=44,
	ClassId_Segmenter=45,
	ClassId_SegmenterMarkupContext=46,
	ClassId_StatisticsBuilder=47,
	ClassId_StatisticsIterator=48,
	ClassId_StatisticsProcessor=49,
	ClassId_StatisticsViewer=50,
	ClassId_StorageAlterMetaDataTable=51,
	ClassId_StorageClient=52,
	ClassId_StorageDocument=53,
	ClassId_StorageDocumentUpdate=54,
	ClassId_StorageDump=55,
	ClassId_Storage=56,
	ClassId_StorageObjectBuilder=57,
	ClassId_StorageTransaction=58,
	ClassId_SummarizerFunctionContext=59,
	ClassId_SummarizerFunctionInstance=60,
	ClassId_SummarizerFunction=61,
	ClassId_TextProcessor=62,
	ClassId_TokenizerFunctionInstance=63,
	ClassId_TokenizerFunction=64,
	ClassId_TokenMarkupContext=65,
	ClassId_TokenMarkupInstance=66,
	ClassId_ValueIterator=67,
	ClassId_VectorStorageClient=68,
	ClassId_VectorStorageDump=69,
	ClassId_VectorStorage=70,
	ClassId_VectorStorageSearch=71,
	ClassId_VectorStorageTransaction=72,
	ClassId_WeightingFunctionContext=73,
	ClassId_WeightingFunctionInstance=74,
	ClassId_WeightingFunction=75
};
