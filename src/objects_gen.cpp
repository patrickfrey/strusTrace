...
{
	TraceLogRecordHandle callhnd = traceContext()->logger()->logMethodCall( TraceClassNameMap::className( ClassId_SentenceAnalyzerInstance), SentenceAnalyzerInstanceConst::methodName( Method_Destructor), objid());
	traceContext()->logger()->logMethodTermination( callhnd, std::vector<TraceElement>());
}
...
{
	TraceLogRecordHandle callhnd = traceContext()->logger()->logMethodCall( TraceClassNameMap::className( ClassId_SentenceLexerContext), SentenceLexerContextConst::methodName( Method_Destructor), objid());
	traceContext()->logger()->logMethodTermination( callhnd, std::vector<TraceElement>());
}
...
void SentenceLexerInstanceImpl::addSpace(
			int p1)
{
	TraceLogRecordHandle callhnd = traceContext()->logger()->logMethodCall( TraceClassNameMap::className( ClassId_SentenceLexerInstance), SentenceLexerInstanceConst::methodName( Method_addSpace), objid());
	obj()->addSpace(p1);
	TraceSerializer parambuf;
	parambuf.packVoid();
	parambuf.packInt(p1);
			...
			const std::string& p1) const
{
	...
	{
		TraceObjectBase* objbase_p0 = dynamic_cast<TraceObjectBase*>( p0);
		if (!objbase_p0) parambuf.packVoid(); else parambuf.packObject( TraceClassNameMap::className( ClassId_SentenceLexerContext), objbase_p0->objid());
		parambuf.packString(p1);
	}
	if (parambuf.hasError())
	{
...
{
	TraceLogRecordHandle callhnd = traceContext()->logger()->logMethodCall( TraceClassNameMap::className( ClassId_StatisticsBuilder), StatisticsBuilderConst::methodName( Method_createIteratorAndRollback), objid());
	StatisticsIteratorInterface* p0 = obj()->createIteratorAndRollback();
	p0 = traceContext()->createInterfaceImpl<StatisticsIteratorInterface,StatisticsIteratorImpl>( p0);
	TraceSerializer parambuf;
	if (p0 == 0)
	{
		char fmtbuf[ 1024];
		std::snprintf( fmtbuf, sizeof(fmtbuf), _TXT("method call '%s' failed: %%s"), "createIteratorAndRollback");
		traceContext()->errorbuf()->explain( fmtbuf);
	}
	else
	{
...
void StatisticsBuilderImpl::releaseStatistics(
			const TimeStamp& p1)
{
	TraceLogRecordHandle callhnd = traceContext()->logger()->logMethodCall( TraceClassNameMap::className( ClassId_StatisticsBuilder), StatisticsBuilderConst::methodName( Method_releaseStatistics), objid());
...
StatisticsMessage StatisticsIteratorImpl::getNext()
{
	...
	StatisticsMessage p0 = obj()->getNext();
	TraceSerializer parambuf;
...
PostingIteratorInterface* StorageClientImpl::createFieldPostingIterator(
			const std::string& p1, 
			const std::string& p2) const
{
	TraceLogRecordHandle callhnd = traceContext()->logger()->logMethodCall( TraceClassNameMap::className( ClassId_StorageClient), StorageClientConst::methodName( Method_createFieldPostingIterator), objid());
	PostingIteratorInterface* p0 = obj()->createFieldPostingIterator(p1, p2);
	p0 = traceContext()->createInterfaceImpl<PostingIteratorInterface,PostingIteratorImpl>( p0);
	TraceSerializer parambuf;
	if (p0 == 0)
	{
		char fmtbuf[ 1024];
		std::snprintf( fmtbuf, sizeof(fmtbuf), _TXT("method call '%s' failed: %%s"), "createFieldPostingIterator");
		traceContext()->errorbuf()->explain( fmtbuf);
	}
	else
	{
...
StatisticsIteratorInterface* StorageClientImpl::createAllStatisticsIterator() const
{
	...
	{
		char fmtbuf[ 1024];
		std::snprintf( fmtbuf, sizeof(fmtbuf), _TXT("method call '%s' failed: %%s"), "createAllStatisticsIterator");
		traceContext()->errorbuf()->explain( fmtbuf);
	}
	else
	{
			...
			const TimeStamp& p1) const
{
	...
	{
		char fmtbuf[ 1024];
		std::snprintf( fmtbuf, sizeof(fmtbuf), _TXT("method call '%s' failed: %%s"), "createChangeStatisticsIterator");
		traceContext()->errorbuf()->explain( fmtbuf);
	}
	else
	{
			...
			const DatabaseInterface* p2) const
{
	...
	{
		char fmtbuf[ 1024];
		std::snprintf( fmtbuf, sizeof(fmtbuf), _TXT("method call '%s' failed: %%s"), "createAlterMetaDataTable");
		traceContext()->errorbuf()->explain( fmtbuf);
	}
	else
	{
...
SentenceAnalyzerInstanceInterface* StorageObjectBuilderImpl::createSentenceAnalyzer(
			const std::string& p1) const
{
	TraceLogRecordHandle callhnd = traceContext()->logger()->logMethodCall( TraceClassNameMap::className( ClassId_StorageObjectBuilder), StorageObjectBuilderConst::methodName( Method_createSentenceAnalyzer), objid());
	SentenceAnalyzerInstanceInterface* p0 = obj()->createSentenceAnalyzer(p1);
	p0 = traceContext()->createInterfaceImpl<SentenceAnalyzerInstanceInterface,SentenceAnalyzerInstanceImpl>( p0);
	TraceSerializer parambuf;
	if (p0 == 0)
	{
		char fmtbuf[ 1024];
		std::snprintf( fmtbuf, sizeof(fmtbuf), _TXT("method call '%s' failed: %%s"), "createSentenceAnalyzer");
		traceContext()->errorbuf()->explain( fmtbuf);
	}
	else
	{
		TraceObjectBase* objbase_p0 = dynamic_cast<TraceObjectBase*>( p0);
		if (!objbase_p0) parambuf.packVoid(); else parambuf.packObject( TraceClassNameMap::className( ClassId_SentenceAnalyzerInstance), objbase_p0->objid());
		parambuf.packString(p1);
	}
	if (parambuf.hasError())
	{
