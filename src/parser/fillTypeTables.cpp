...
void strus::fillTypeTables( TypeSystem& typesystem)
{
	...
	;
	typesystem.defineType( "const StructureHeaderField&")
		("pack_msg", "parambuf.packStructureHeaderField($name);")
	;
	typesystem.defineType( "StructureHeaderField")
		("pack_msg", "parambuf.packStructureHeaderField($name);")
	;
	...
	;
	typesystem.defineType( "const StructureType&", "DocumentAnalyzerInstanceInterface")
		("pack_msg", "parambuf.packDocumentAnalyzerStructureType($name);")
	;
