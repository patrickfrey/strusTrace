 ...
 */
#ifndef _STRUS_SHADOW_OBJECT_MAP_HPP_INCLUDED
#define _STRUS_SHADOW_OBJECT_MAP_HPP_INCLUDED
...
public:
	...
	{
		m_objmap.push_back( Object( obj, ShadowObjDeleter<Interface>::call));
